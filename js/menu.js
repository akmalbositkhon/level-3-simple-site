var menuItems = ['Home','Contact', 'About', 'Galleries', 'Nature In Photos'];
var dropItem=['Mountains', 'Birds', 'Animals', 'Insects', 'Flowers', 'Forests', 'Oceans', 'Fishes', 'Beaches', 'Deserts'];
var firstColumn=['Home', 'Galleries', 'Contact'];
...
window.onload = function(){
	menuItems.forEach((item)=>{
		...
		a.setAttribute('href', (item.toLowerCase() === 'nature in photos'|| item.toLowerCase()==="home") ? 'index.html' : item.toLowerCase() + '.html');
		if(item.toLowerCase()==="nature in photos"&&item.toLowerCase()==="home"){
